...
public class WorkouReferenceDTO {
    ...
    public WorkouReferenceDTO(Long id, String title, String schedule_type, LocalDateTime schedule_date, Boolean completed){
        if (id != null) {
            this.id = id;
            return;
        }
        if (title != null && !title.isBlank() && schedule_type != null && schedule_date != null && completed != null) {
            this.title = title;
            ...
            this.scheduled_date = schedule_date;
